...
import { UploadPlaceProfile } from "../components/createPlace/uploadPlaceProfile";
import { UploadPlaceBanner } from "../components/createPlace/uploadPlaceBanner";
  ...
  return (
    <Container className="mt-5 create_event_container">
      <Form onSubmit={handleSubmit}>
        <Row>
          <Col xs={12} md={12}>
            <UploadPlaceProfile onUpload={handleUpload} />
            <UploadPlaceBanner
